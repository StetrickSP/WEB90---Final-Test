    ...
    return (
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-6 text-sm">
                        Experience the power of AI learning with Vertena Scholar <br />
                        Transform your learning journey with our suite of premium AI Tools. Write essays, generate images, and enhance your learning!
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            ...
                            <div className="flex items-center gap-2 pt-4">
                               ...
                               {/* Add newsletter subscription function here */} 
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright 2025 ©<a href="https://prebuiltui.com">Vertena</a>. All Rights Reserved.
            </p>
        </footer>
    );
};